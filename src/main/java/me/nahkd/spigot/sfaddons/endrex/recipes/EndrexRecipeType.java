...
public class EndrexRecipeType extends RecipeType {
	...
	public static void init(Endrex plugin) {
		...
		LIQUID_STORAGE = new EndrexRecipeType(new NamespacedKey(plugin, "liquid_storage"), new CustomItem(EndrexSkullItems.RESONANT_ENDER_BUCKET, "&eLiquid Storage", "&7Get this item from liquid", "&7storage."));
	}
